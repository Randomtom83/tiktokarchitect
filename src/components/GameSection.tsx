    ...
    <section className="sheet bg-yellow text-ink" id="game">
      ...
      <div className="relative z-[2] grid grid-cols-1 lg:grid-cols-[6fr_5fr] gap-16 pt-10">
        <div>
          ...
          <a
            href="#"
            className="inline-flex justify-between items-center mt-8 py-5 px-6 bg-ink text-[#f4c430] no-underline font-serif text-[30px] italic min-w-0 sm:min-w-[360px] border-3 border-ink gap-8 hover:-translate-x-[3px] hover:-translate-y-[3px] hover:shadow-[6px_6px_0_var(--ink)] transition-all duration-200"
          >
            <span>Download APK<br />↓</span>
            <span className="font-mono not-italic text-[11px] tracking-[0.18em] uppercase text-[#f4c430] text-right leading-relaxed">
